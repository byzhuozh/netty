...
public abstract class MultithreadEventExecutorGroup extends AbstractEventExecutorGroup {
    ...
    protected MultithreadEventExecutorGroup(int nThreads, Executor executor,
        ...
        // 创建 EventExecutor 选择器  根据 children 数组的大小是否是2 幂次方，有两种实现
        ...
        readonlyChildren = Collections.unmodifiableSet(childrenSet);  //  Collections.unmodifiableSet() 返回一个不可修改的集合
    }
    ...
    protected ThreadFactory newDefaultThreadFactory() {
        return new DefaultThreadFactory(getClass());  // 线程工厂，默认的线程优先级是 5
    }
